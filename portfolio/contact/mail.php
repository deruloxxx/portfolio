...
<title>Confirm | Riuya uetake</title>
...
<?php }else{ ?>
<h2>Confirm</h2>
<p align="center">以下の入力内容でお間違いないかご確認ください。</p>
...
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
<meta name="format-detection" content="telephone=no">
<title>Complete | Riuyauetake</title>
</head>
<body>
<div align="center">
<?php if($empty_flag == 1){ ?>
<h4>入力にエラーがあります。下記をご確認の上、修正をお願い致します。</h4>
...
<?php }else{ ?>
お問合せありがとうございます。 <br />
ご連絡までに2～3日程度お時間いただく場合がございます。 <br />
暫くお待ちください。 <br /><br />
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://www.php-factory.net/" target="_blank">©︎2019 Riuya</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
